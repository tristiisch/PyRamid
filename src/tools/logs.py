...
from tools.utils import create_parent_directories
...
class Logger:
	...
	def log_to_file(self):
		...
		create_parent_directories(log_filename)
	...
	def __handle_unhandled_exception(self, exc_type, exc_value, exc_traceback):
		...
		self.logger_unhandled_exception.critical(self.info, exc_info=(exc_type, exc_value, exc_traceback))
